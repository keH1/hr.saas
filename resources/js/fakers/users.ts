...
const imageAssets = import.meta.glob<{
  default: string;
}>("/public/images/users/*.{jpg,jpeg,png,svg}", { eager: true });
    ...
    const users: Array<User> = [
      {
        ...
        photo: imageAssets["/public/images/users/user1-50x50.jpg"].default,
      ...
      },
      {
        ...
        photo: imageAssets["/public/images/users/user2-50x50.jpg"].default,
      ...
      },
      {
        ...
        photo: imageAssets["/public/images/users/user3-50x50.jpg"].default,
      ...
      },
      {
        ...
        photo: imageAssets["/public/images/users/user4-50x50.jpg"].default,
      ...
      },
      {
        ...
        photo: imageAssets["/public/images/users/user5-50x50.jpg"].default,
      ...
      },
      {
        ...
        photo: imageAssets["/public/images/users/user6-50x50.jpg"].default,
      ...
      },
      {
        ...
        photo: imageAssets["/public/images/users/user7-50x50.jpg"].default,
      ...
      },
      {
        ...
        photo: imageAssets["/public/images/users/user8-50x50.jpg"].default,
      ...
      },
      {
        ...
        photo: imageAssets["/public/images/users/user9-50x50.jpg"].default,
      ...
      },
      {
        ...
        photo: imageAssets["/public/images/users/user10-50x50.jpg"].default,
